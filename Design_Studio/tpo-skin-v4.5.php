<?php
/**
 * Plugin Name: TPO Skin Injector (V4.5 - Cali Audio Logo)
 * Description: Simplified TP + Audio Logo.
 * Version: 4.5
...
function tpo_rebuild_header() {
    ...
    // NEW SVG LOGO URL
    $logo_svg_url = content_url('uploads/2025/12/tpo-logo-v2.svg'); 
...
function tpo_inject_modern_css() {
    ...
    <style>
        ...
        /* LOGO IMG */
        .tpo-logo-svg { height: 50px; width: auto; }
