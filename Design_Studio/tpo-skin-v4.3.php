<?php
/**
 * Plugin Name: TPO Skin Injector (Cali Cool Logo v4.3)
 * Description: Simplified Nav + New Stylized Logo.
 * Version: 4.3
...
function tpo_rebuild_header() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        link.href = 'https://fonts.googleapis.com/css2?family=Russo+One&family=Teko:wght@300;600&display=swap';
        link.rel = 'stylesheet';
        ...
        if(headerRow) {
            ...
            logoDiv.innerHTML = "` +
                "<a href=\"" + {$home_url} + "\" class=\"tpo-brand-link\">
                    <div class=\"tpo-icon-box\">
                        <span class=\"tpo-tp\">TP</span>
                    </div>
                    <div class=\"tpo-brand-stack\">
                        <span class=\"tpo-brand-main\">TREASURE <span class=\"tpo-red-text\">POINT</span></span>
                        <span class=\"tpo-brand-sub\">AUDIO <span class=\"tpo-sub-tag\">SYSTEMS</span></span>
                    </div>
                </a>
            ";
...
function tpo_inject_modern_css() {
    ...
    <style>
        ...
        /* === NEW LOGO STYLES === */
        .tpo-brand-link { display: flex; align-items: center; text-decoration: none; gap: 12px; }
        
        /* Icon Box */
        .tpo-icon-box { 
            background: linear-gradient(135deg, #222, #000); 
            border: 2px solid var(--tpo-red); 
        ...
        /* Text Stack */
        .tpo-brand-stack { display: flex; flex-direction: column; line-height: 0.9; }
        ...
        .tpo-red-text { color: var(--tpo-red); }
        ...
        .tpo-sub-tag { color: var(--tpo-red); font-weight: 600; }
