<?php
/**
 * Plugin Name: TPO Skin Injector (V4.4 - SVG Logo Image)
 * Description: Uses uploaded SVG logo file + Simplified Nav.
 * Version: 4.4
...
function tpo_rebuild_header() {
    ...
    // SVG LOGO URL
    $logo_svg_url = content_url('uploads/2025/12/tpo-logo.svg'); 
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if(headerRow) {
            ...
            // NEW LOGO: IMG TAG REFERENCING UPLOADED SVG
            var logoDiv = document.createElement('div');
            logoDiv.className = 'tpo-logo-area';
            logoDiv.innerHTML = `<a href="{$home_url}" class="tpo-brand-link"><img src="{$logo_svg_url}" alt="Treasure Point Logo" class="tpo-logo-svg"></a>`;
...
function tpo_inject_modern_css() {
    ...
    <style>
        ...
        /* === LOGO STYLES (IMG) === */
        .tpo-logo-svg { height: 45px; width: auto; } /* Adjust size as needed */
