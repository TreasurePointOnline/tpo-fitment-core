<?php
/**
 * Plugin Name: TPO Skin Injector (Award Edition - Fixed)
...
function tpo_inject_search_bar() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if(header && !document.querySelector('.tpo-header-search')) {
            ...
            searchDiv.innerHTML = '<form role="search" method="get" class="woocommerce-product-search" action="{$search_url}">' +
                    '<input type="search" class="search-field" placeholder="Search..." value="{$search_query}" name="s" />' +
